...
// string and those redirects become relative (e.g. "/api/apps/auth/login"),
// which only happens to work when the app is hosted directly on its own
// base44.app domain — on any other host (localhost, a custom domain) the
// redirect just hits our own server and breaks. Setting it explicitly fixes
// Google login everywhere, including local dev.
